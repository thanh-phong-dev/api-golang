...
type User struct {
	...
	Email1   null.String `boil:"email1" json:"email1,omitempty" toml:"email1" yaml:"email1,omitempty"`
...
var UserWhere = struct {
	...
	Email1   whereHelpernull_String
}{
	ID:       whereHelperint{field: "\"users\".\"id\""},
	Username: whereHelperstring{field: "\"users\".\"username\""},
	Password: whereHelperstring{field: "\"users\".\"password\""},
	Email1:   whereHelpernull_String{field: "\"users\".\"email1\""},
}
...
var (
	userAllColumns            = []string{"id", "username", "password", "email1"}
	userColumnsWithoutDefault = []string{"username", "password", "email1"}
...
func (o *User) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(drivers.Dialect(dialect), "\"users\"", updateOnConflict, ret, update, conflict, insert)
